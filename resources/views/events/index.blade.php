                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                                    ...
                                    <tr class="hover:bg-gray-50 hover:dark:bg-gray-800">
                                        ...
                                        <td class="px-6 py-3 whitespace-nowrap">
                                            ...
                                            @elseif((int) ($event->scan_type ?? 1) === 3)
                                                <span class="inline-flex px-2 py-0.5 text-xs font-medium rounded bg-slate-200 text-slate-800 dark:bg-slate-700 dark:text-slate-100">
                                                    LIST
                                                </span>
                                            @else
